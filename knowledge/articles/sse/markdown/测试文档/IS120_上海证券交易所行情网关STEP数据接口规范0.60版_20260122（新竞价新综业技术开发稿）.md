...
1. 调整市场状态消息中股票、基金、指数及债券分销（ SecurityType = 01 ）和债券市场
...
2.1.4
行情数据发布
在完成建立行情会话之后， MDGW 将向 VSS 发送行情数据消息。行情数据消息格式将在
- 3 -

技术文档
第 5 章 “ 应用消息 ” 中详细叙述。 MDGW 目前发布的行情应用消息不支持重传。
2.1.5
关闭行情会话
...
技术文档
信线路的状况。对方用带有测试请求标识符（ TestReqID ）的心跳作应答。 MDGW 不会主动发
送此消息，但会遵循 FIX 标准引擎规则而响应 VSS 的测试请求消息。
测试请求消息格式如下：
Tag
域名
必需
...
‘E’ 表示综合业务市场处于闭市期间
第 2 位
‘1’ 表示综合业务市场开盘集合竞价结束标志，未结束取 ‘0’ <span style="color:red">。当综合业务市场无支</span>
<span style="color:red">持开盘集合竞价的产品时，无意义</span>
第 3 位
‘1’ 表示综合业务市场收盘集合竞价结束标志，未结束取 ‘0’ <span style="color:red">，暂不启用</span>
第 4 位
‘1’ 表示国债预发行市场行情闭市标志，未闭市取 ‘0’ <span style="color:red">。当无发行期内国债预发行产</span>
<span style="color:red">品时，无意义</span>
第 5 位
...
b)
行情条目类别为 w 时， MDEntryPx 表示基金 T-1 日收盘时刻 IOPV 4 ，此条目仅当 MDStreamID=
...
<metadata>
{
  "title": "20260123_IS120_上海证券交易所行情网关STEP数据接口规范0",
  "source_url": null,
  "raw_path": "knowledge\\raw\\sse\\测试文档\\20260123_IS120_上海证券交易所行情网关STEP数据接口规范0.60版_20260122（新竞价新综业技术开发稿）.pdf",
  "markdown_path": "knowledge\\articles\\sse\\markdown\\测试文档\\IS120_上海证券交易所行情网关STEP数据接口规范0.60版_20260122（新竞价新综业技术开发稿）.md",
  "file_hash": "sha256:cce22ce4ac3b570341d5ec5001497ea4bff81ef10fbea3b81bd2755add5045d5",
  "file_format": "pdf",
  "page_count": 32,
  ...
  "parse_date": "2026-05-02T01:48:26.860686+00:00",
  "sub_category": null
}
</metadata>