...
IS120 上海证券交易所行情网关
BINARY 数据接口规范
0.6 <span style="color:blue">2</span> 版
上海证券交易所
二〇二 <span style="color:blue">六</span> 年一月

修订记录
修订日期
版本号
修订内容
<span style="color:blue">2026-01-21</span>
<span style="color:blue">0.62</span>
1 、 <span style="color:blue">2.5.4</span> <span style="color:blue">逐笔行情消息中明确</span> <span style="color:blue">TransactTime</span> <span style="color:blue">为委托或成交的行情</span>
<span style="color:blue">生成时间</span>
2025-11-17
0.61
1 、 2.5.4.2 逐笔成交行情扩展字段中无对应买卖订单编号时调整
为填空。
2 、为保证上下游接口位数统一，调整 TotalValueTraded 、
OrderQty 字段位数。
3 、在重传消息章节中明确：对于无效字段，字符类型字段填空
格，数值类型字段填 0 。
2024-09-25
0.60
...
char[8]
uint32,N9
委托 <span style="color:blue">时间</span> 或成交的 <span style="color:blue">行情生成时间</span> ：
TransactTime
HHMMSSsss
- 25 -
...
<metadata>
{
  ...
  "source_url": null,
  "raw_path": "knowledge\\raw\\sse\\测试文档\\20260424_IS120_上海证券交易所行情网关BINARY数据接口规范0.62版_20260424（新固收技术开发稿）.pdf",
  "markdown_path": "knowledge\\articles\\sse\\markdown\\测试文档\\IS120_上海证券交易所行情网关BINARY数据接口规范0.62版_20260424（新固收技术开发稿）.md",
  "file_hash": "sha256:33f98748aa943f0440d808344988c8755283cc3179893e4319ca770c74219ee4",
  "file_format": "pdf",
  "page_count": 42,
  "doc_type": "interface_spec",
  "version": null,
  "previous_version": null,
  "public_date": "2026-01-21",
  "effective_date": null,
  "has_changes": true,
